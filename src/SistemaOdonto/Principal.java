...
public class Principal extends javax.swing.JFrame {
    ...
    public void LoadTablePac(){
        ...
        tbl_dep_dpts.getColumnModel().getColumn(3).setPreferredWidth(70);
        tbl_dep_dpts.getColumnModel().getColumn(4).setPreferredWidth(200);
        tbl_dep_dpts.getColumnModel().getColumn(5).setPreferredWidth(50);
    ...
    public void LoadCBPac(){
        ...
        cb_func_deps1.removeAllItems();
        cb_func_deps1.addItem("Selecione");
        for(int i=0;i<listaPac.size();i++){
            cb_func_deps.addItem(listaPac.get(i).getNome());
            cb_func_deps1.addItem(listaPac.get(i).getNome());
        }
    }
    ...
    public void ManipulaInterfacePag(){
        switch(modoPag){   
            case "Navegar":
                ...
                cb_func_deps1.setEnabled(false);                
    ...
    private void initComponents() {
        ...
        c_func_desc = new javax.swing.JTextField();
        ...
        cb_func_deps1 = new javax.swing.JComboBox();
        ...
        tbl_dep_dpts.addFocusListener(new java.awt.event.FocusAdapter() {
            public void focusGained(java.awt.event.FocusEvent evt) {
                tbl_dep_dptsFocusGained(evt);
            }
        });
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(c_func_desc)
                            .addGroup(jPanel4Layout.createSequentialGroup()
                                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(c_func_mat, javax.swing.GroupLayout.PREFERRED_SIZE, 81, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(cb_func_deps, javax.swing.GroupLayout.PREFERRED_SIZE, 185, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGap(0, 0, Short.MAX_VALUE)))))
                .addContainerGap())
        );
        jPanel4Layout.setVerticalGroup(
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel4)
                    .addComponent(c_func_desc, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel5)
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(btn_func_excluir, javax.swing.GroupLayout.PREFERRED_SIZE, 92, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        cb_func_deps1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cb_func_deps1ActionPerformed(evt);
            }
        });
                ...
                .addGroup(jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel10Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(cb_func_deps1, 0, 185, Short.MAX_VALUE)
        ...
        jPanel10Layout.setVerticalGroup(
            ...
            .addGroup(jPanel10Layout.createSequentialGroup()
                ...
                .addGroup(jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel23)
                    .addComponent(cb_func_deps1, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel10Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(btn_pag_cancelar)
    ...
    private void btn_sec_salvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_sec_salvarActionPerformed
        ...
        if(verificarCpf(c_sec_cpf.getText())==true){
            if(modoSec.equals("Novo")){
                ...
                listaSec.get(index).setCpf(c_sec_nome.getText());
    ...
    private void btn_dent_salvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_dent_salvarActionPerformed
        ...
        if(verificarCpf(c_dent_cpf.getText())==true){
            if(modoDent.equals("Novo")){
                Dentista DD = new Dentista (cod, c_dent_nome.getText(), c_dent_cpf.getText(), c_dent_sexo.getText(), c_dent_endereco.getText(), c_dent_nasc.getText(),
                    c_dent_esp.getText());
                ...
                listaDent.get(index).setCpf(c_dent_nome.getText());
            ...
            JOptionPane.showMessageDialog(rootPane, "CPF Inexistente, tente outra vez");
    ...
    private void btn_func_salvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_func_salvarActionPerformed
        ...
        if(index==0){
            ...
            F.setDescricao(c_func_desc.getText());
    ...
    private void btn_pac_editarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_pac_editarActionPerformed
        ...
        try {
            ...
            rs = ps.executeQuery();
            TableModel tabela=tbl_dep_dpts.getModel();
            ...
            while (rs.next()) {
               ...
               /*/     ps = Conexao.conexao().prepareStatement("Update paciente set cpf = ?,nome_pac = ?,sexo = ?,endereco = ?,data_nasc = ? Where cpf = ?" );
                    ps.setString(1, c_pac_cpf.getText());
                    ps.setString(2, c_pac_nome.getText());
                    ps.setString(3, c_pac_sexo.getText());
                    ps.setString(4, c_pac_endereco.getText());
                    ps.setString(5, c_pac_nasc.getText());
                    ps.setString(6, listaPacAuxDelet.get(0).getCpf()); 
                    ps.executeUpdate();
               /*/     
    ...
    private void btn_pag_salvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_pag_salvarActionPerformed
        int index = cb_func_deps1.getSelectedIndex();
        if(index==0){
           JOptionPane.showMessageDialog(this,"Você deve selecionar um Paciente");
        }else{
            ...
            pp.setValor(Double.parseDouble(c_pag_valor.getText()));
    ...
    private void cb_func_deps1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cb_func_deps1ActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_cb_func_deps1ActionPerformed
    ...
    private void tbl_dep_dptsFocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_tbl_dep_dptsFocusGained
        // TODO add your handling code here:
    }//GEN-LAST:event_tbl_dep_dptsFocusGained
    ...
    private javax.swing.JTextField c_func_desc;
    ...
    private javax.swing.JComboBox cb_func_deps1;
